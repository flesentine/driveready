...
const fullQMap: { [qId: string]: string[] } = {
  ...
  q16: ['fact-highway-entry-match-traffic-speed'],
  q17: ['fact-uturn-residential-clearance'],
  q18: ['fact-pass-on-right-allowed'],
  q19: ['fact-illegal-parking-double-parking'],
  q20: ['fact-passing-prohibited-100-feet-hazard'],
